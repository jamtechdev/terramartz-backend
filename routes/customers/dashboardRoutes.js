...
import { getOrderHistory, getOrderBySessionId, getOrderByOrderId } from "../../controllers/customers/getOrderHistoryController.js";
...
import { generateInvoice } from "../../controllers/customers/invoiceController.js";
...
router.get("/dashboard/order/:orderId", protect, getOrderByOrderId);
...
router.get("/dashboard/invoice/:orderId", protect, generateInvoice);
...
router.get("/order/:orderId", protect, getOrderByOrderId);
